...
public class Main {
  public static void main(String[] args) {
    ...
    // Define classes
    Resource persona = model.createResource(ex + "Persona").addProperty(RDF.type, RDFS.Class);
    Resource curso = model.createResource(ex + "Curso").addProperty(RDF.type, RDFS.Class);
