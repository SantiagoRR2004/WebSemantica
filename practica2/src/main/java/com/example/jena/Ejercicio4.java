...
public class Ejercicio4 {
  public static void main(String[] args) {
    ...
    // 4.2
    alice.addProperty(FOAF.name, "Alice").addProperty(FOAF.mbox, "<mailto:alice@example.org>");
    ...
    bob.addProperty(FOAF.knows, alice).addProperty(FOAF.age, "30");
    ...
    address.addProperty(street, "Progreso").addProperty(city, "Ourense");
