...
public class Part2 {
    ...
    public static void main(String[] args) {
        ...
        hasGender.addProperty(RDF.type, RDF.Property)
                .addProperty(RDFS.domain, person)
                .addProperty(RDFS.range, gender);
        isRelatedTo.addProperty(RDF.type, RDF.Property)
                .addProperty(RDFS.domain, person)
                .addProperty(RDFS.range, person);
        hasMemberFamily.addProperty(RDF.type, RDF.Property)
                .addProperty(RDFS.domain, person)
                .addProperty(RDFS.range, family);
        hasSiblings.addProperty(RDF.type, RDF.Property)
                .addProperty(RDFS.domain, person)
                .addProperty(RDFS.range, person);
        hasBrother.addProperty(RDFS.subPropertyOf, hasSiblings);
        hasSister.addProperty(RDFS.subPropertyOf, hasSiblings);
        hasProgenitor.addProperty(RDFS.subPropertyOf, isRelatedTo)
                .addProperty(RDFS.domain, person)
                .addProperty(RDFS.range, person);
